...
int giris(void)
{
     ...
     outtextxy(250,220,"Yarýþmak hiç bu kadar heyecanlý olmamýþtý!!!");
     outtextxy(390,250,"Seçiminizi Yapýn:");
     outtextxy(390,280,"1: Oyuna Baþla");
     outtextxy(390,300,"2: Bir Önceki Skor");
     outtextxy(390,320,"3: Bilgiler");
     outtextxy(390,340,"4: Çýkýþ");
     secim=getch();
     if(secim==49) return 1;
                   ...
                   settextstyle(0,0,0);
                   outtextxy(560,190,"Underground :)");
                   outtextxy(320,220,"Bir önceki oyuncunun kayýtlarý");
                   outtextxy(220,300,"Oyunda geçirdiði süre(sn)");
                   line(220,320,445,320);
                   outtextxy(530,300,"Kazandýðý Puan:");
                   ...
                   outtextxy(170,220,"Arabanýn saðlýklý hareket edebilmesi için tuþlara basýlý tutmayýn.");
                   outtextxy(170,240,"Hýzýnýza göre puanýnýza +1, +3, +5, +10 ve +15 deðerleri eklenir.");
                   outtextxy(170,260,"Yol dýþýna çýkarsanýz puanýnýz 50 eksilir, hýzýnýz azalýr.");
                   outtextxy(170,280,"Oyun süresi minimum 1 dakika, maksimum 3 dakika arasýndadýr.");
                   outtextxy(170,300,"Bu süre rastgele üretilecektir. Artýk ne çýkarsa þansýnýza :)");
                   secim=getch();
                   goto menu;
                   }
...
{
     settextstyle(11,0,0);
     outtextxy(860,100,"Araba Yarýþý");
     outtextxy(850,130,"Hasan's Speed");
     outtextxy(810,300,"NOT: Saðlýklý hareket için");
     outtextxy(810,320,"tuþlara basýlý tutmayýn. :)");
     outtextxy(810,560,"Puanýnýz:");
...
void bitismenusu(void)
{
     ...
     outtextxy(150,240,"Puan ve süre bilgilerini sað menüde görüyorsunuz.");
     outtextxy(150,260,"Menüye dönmek için bir tuþa basýnýz...");
     getch();
}
...
int main(void)
{
    ...
    oyun: while(1)
    {
            ...
            if(difftime(gecensure,baslangiczamani)>=60.000000+eksure&&uyolsol==300){ do {
                                                                              ...
                                                                              bar(finissag,finisy,finissag-direk,finisy+200);//saðdirek
                                                                              finisy+=10;
                                                                              finissol-=5;
                                                                              finissag+=5;
                                                                              direk+=1;
